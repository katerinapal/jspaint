import { file_name } from "..\\src\\app.js";
import { app_palette_modificationFunc_20 } from "..\\src\\app.js";
import { app_palette_modificationFunc_19 } from "..\\src\\app.js";
import { app_palette_modificationFunc_18 } from "..\\src\\app.js";
import { app_palette_modificationFunc_17 } from "..\\src\\app.js";
import { app_palette_modificationFunc_16 } from "..\\src\\app.js";
import { app_palette_modificationFunc_15 } from "..\\src\\app.js";
import { app_palette_modificationFunc_14 } from "..\\src\\app.js";
import { app_palette_modificationFunc_13 } from "..\\src\\app.js";
import { app_palette_modificationFunc_12 } from "..\\src\\app.js";
import { app_palette_modificationFunc_11 } from "..\\src\\app.js";
import { app_palette_modificationFunc_10 } from "..\\src\\app.js";
import { palette } from "..\\src\\app.js";
import { test_fs_modificationFunc_0 } from "..\\test.js";
import { fs } from "..\\test.js";
import { e } from ".\\font-detective.js";
...
load_palette = function(o, callback) {
  ...
  for (k = 0, len1 = palette_loaders.length; k < len1; k++) {
    ...
    try {
      app_palette_modificationFunc_10();
      if (palette.length === 0) {
        app_palette_modificationFunc_11();
...
module.exports = function(arg) {
  ...
  data = arg.data;
  app_palette_modificationFunc_12();
...
module.exports = function(arg) {
  ...
  app_palette_modificationFunc_13();
  i = 1;
...
module.exports = function(arg) {
  ...
  for (i = 0, len = palettes.length; i < len; i++) {
    app_palette_modificationFunc_14();
...
module.exports = function(arg) {
  ...
  app_palette_modificationFunc_15();
...
module.exports = function(arg) {
  ...
  data = arg.data;
  app_palette_modificationFunc_16();
  hex = function(x) {
    return parseInt(x, 16);
  };
  ref = data.split(/[\n\r]+/m);
...
module.exports = function(arg) {
  ...
  app_palette_modificationFunc_17();
  for (i = j = 0, len = lines.length; j < len; i = ++j) {
    line = lines[i];
    if (line !== "" && i > 2) {
      rgb = line.split(" ");
...
module.exports = function(arg) {
  ...
  app_palette_modificationFunc_18();
  i = 0;
...
module.exports = function(arg) {
  ...
  data = arg.data;
  app_palette_modificationFunc_19();
  br = new BinaryReader(data);
  for (i = j = 0; j < 255; i = ++j) {
    palette.add({
      r: br.readByte(),
...
module.exports = function(arg) {
  var br, data, i, j, palette;
  data = arg.data;
  app_palette_modificationFunc_20();
  br = new BinaryReader(data);
  for (i = j = 0; j < 255; i = ++j) {
    palette.add({
      r: br.readByte(),
